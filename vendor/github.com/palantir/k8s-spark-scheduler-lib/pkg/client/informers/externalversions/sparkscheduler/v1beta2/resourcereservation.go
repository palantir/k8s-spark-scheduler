...
import (
	...
	v1beta2 "github.com/palantir/k8s-spark-scheduler-lib/pkg/client/listers/sparkscheduler/v1beta2"
...
type ResourceReservationInformer interface {
	...
	Lister() v1beta2.ResourceReservationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SparkschedulerV1beta2().ResourceReservations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SparkschedulerV1beta2().ResourceReservations(namespace).Watch(context.TODO(), options)
			},
		},
		&sparkschedulerv1beta2.ResourceReservation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceReservationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sparkschedulerv1beta2.ResourceReservation{}, f.defaultInformer)
}

func (f *resourceReservationInformer) Lister() v1beta2.ResourceReservationLister {
	return v1beta2.NewResourceReservationLister(f.Informer().GetIndexer())
}
