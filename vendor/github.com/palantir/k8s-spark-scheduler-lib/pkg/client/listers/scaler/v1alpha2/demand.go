...
type DemandLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.Demand, err error)
...
// List lists all Demands in the indexer.
func (s *demandLister) List(selector labels.Selector) (ret []*v1alpha2.Demand, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.Demand))
	})
	return ret, err
}
...
type DemandNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.Demand, error)
...
// List lists all Demands in the indexer for a given namespace.
func (s demandNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.Demand, err error) {
...
// Get retrieves the Demand from the indexer for a given namespace and name.
func (s demandNamespaceLister) Get(name string) (*v1alpha2.Demand, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("demand"), name)
	}
	return obj.(*v1alpha2.Demand), nil
}
