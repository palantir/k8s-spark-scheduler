...
type ResourceReservationLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.ResourceReservation, err error)
...
// List lists all ResourceReservations in the indexer.
func (s *resourceReservationLister) List(selector labels.Selector) (ret []*v1beta2.ResourceReservation, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.ResourceReservation))
	})
	return ret, err
}
...
type ResourceReservationNamespaceLister interface {
	...
	Get(name string) (*v1beta2.ResourceReservation, error)
...
// List lists all ResourceReservations in the indexer for a given namespace.
func (s resourceReservationNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.ResourceReservation, err error) {
...
// Get retrieves the ResourceReservation from the indexer for a given namespace and name.
func (s resourceReservationNamespaceLister) Get(name string) (*v1beta2.ResourceReservation, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("resourcereservation"), name)
	}
	return obj.(*v1beta2.ResourceReservation), nil
}
